...
class Zebra(animals.Animal):
    def __init__(self, animal_id, mother_genome, father_genome):
        ...
        self.species = 'Zebra'
        self.trait_init_dict = Zebra.trait_init_dict

        self.image_dict = {0: 'assets/images/Zebra0.gif',
                           90: 'assets/images/Zebra90.gif',
                           180: 'assets/images/Zebra180.gif',
                           270: 'assets/images/Zebra270.gif'}
    ...
    trait_init_dict = {'Sex': (0, 'int', None, 'immutable', 'invisible'),
                       ...
                       'Digest Plants': (2, 'float', (1.0, 0.0), 'mutable', 'invisible'),
                       'Digest Meat': (2, 'float', (0.0, 0.0), 'mutable', 'invisible'),
                       'Sharp Teeth': (2, 'float', (0.0, 0.0), 'mutable', 'visible'),

                       'Num Hidden Neurons': (3, 'int', (100, 20), 'mutable', 'invisible'),
                       'Weight Init Stdev': (3, 'float', (.01, .10), 'mutable', 'invisible'),
                       ...
                       'Primary Coloring R': (2, 'float', (0.80, 0.05), 'mutable', 'visible'),
                       'Primary Coloring G': (2, 'float', (0.60, 0.05), 'mutable', 'visible'),
                       'Primary Coloring B': (2, 'float', (0.35, 0.05), 'mutable', 'visible'),
                       'Secondary Coloring R': (2, 'float', (0.30, 0.05), 'mutable', 'visible'),
                       'Secondary Coloring G': (2, 'float', (0.20, 0.05), 'mutable', 'visible'),
                       'Secondary Coloring B': (2, 'float', (0.15, 0.05), 'mutable', 'visible')
                       }
