...
class SummaryFrame(tk.Frame):
    ...
    def __init__(self, display):
        ...
        self.species_summary_window_instance = None
    ...
    def update_summary_display(self):
        ...
        self.zebra_image_label.bind('<Double-Button-1>',
                                   lambda event, arg='Zebra': self.animal_summary_on_double_click(event, arg))
        self.zebra_text_label.bind('<Double-Button-1>',
                                  lambda event, arg='Zebra': self.animal_summary_on_double_click(event, arg))
        ...
        self.lion_image_label.bind('<Double-Button-1>',
                                   lambda event, arg='Lion': self.animal_summary_on_double_click(event, arg))
        self.lion_text_label.bind('<Double-Button-1>',
                                  lambda event, arg='Lion': self.animal_summary_on_double_click(event, arg))

    ############################################################################################################
    def animal_summary_on_double_click(self, event, species):
